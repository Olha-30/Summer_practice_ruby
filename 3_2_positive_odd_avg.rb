# Написати програму, яка обчислює середнє арифметичне всіх парних додатніх чисел even 
...
def mean_odd_positive
    ...
    while (loop_index <= arr)
	     if(loop_index%2 == 0)
		     sum_of_odd_positive = sum_of_odd_positive + loop_index
